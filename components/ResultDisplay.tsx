...
const ResultDisplay: React.FC<ResultDisplayProps> = ({ content, onUseImageAsInput, onImageClick, originalImageUrl, exampleImage }) => {
    ...
    <div className="w-full h-full flex flex-col items-center gap-4 animate-fade-in">
      ...
      <div className="w-full flex-grow relative">
        {viewMode === 'result' && (content.imageUrl || showExampleImage) && (
          ...
          >
            <img src={content.imageUrl || exampleImage} alt={content.imageUrl ? "Generated result" : "Example result"} className="max-w-full max-h-full object-contain" />
            {content.imageUrl && (
