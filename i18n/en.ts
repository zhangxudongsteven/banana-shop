export default {
  ...
  apiKeys: {
    ...
    title: 'API Keys',
    description:
      'Create personal API keys for the REST API, MCP server, scripts, and automation clients.',
    createTitle: 'Create API Key',
    createDescription:
      'The same key works with the REST API and MCP server. The full key is shown only once. Copy it now and store it securely.',
    nameLabel: 'Name',
    namePlaceholder: 'e.g. Local script, Claude Desktop',
    create: 'Create Key',
    created: 'API key created',
    createdTitle: 'Copy your API key',
    createdDescription: 'You will not be able to view the full key again after leaving this page.',
    copy: 'Copy Key',
    copied: 'Copied',
    viewDocs: 'View API Docs',
    viewMcpDocs: 'View MCP Docs',
    listTitle: 'Created API Keys',
    listDescription: 'Review usage status or revoke keys you no longer use.',
    refresh: 'Refresh',
    loading: 'Loading API keys...',
    empty: 'No API keys yet.',
    noActive: 'There are no active API keys.',
    revokedSection: 'Revoked API Keys',
    revoke: 'Revoke',
  ...
  apiDocs: {
    ...
    description:
      'Use a personal API key to call Banana Shop from scripts, automations, or clients.',
    ...
    errorsDescription: 'APIs return JSON in the shape: { success, data?, error? }.',
    errors: {
      '400': 'The request body is missing required fields or contains invalid values.',
      '401': 'The API key is missing, invalid, or revoked.',
      '403': 'The API key does not have the required scope for this endpoint.',
      '500': 'The server, Tale, or AI provider request failed.',
    },
  },
  mcpDocs: {
    menu: 'MCP Docs',
    title: 'MCP Server Documentation',
    description: 'Expose Banana Shop as a local stdio MCP server for external agents.',
    manageKeys: 'Manage API Keys',
    viewApiDocs: 'View REST API',
    startTitle: 'Start Server',
    startDescription:
      'The MCP server runs as a local Node process and reads the API key from an environment variable or process argument.',
    envExample: 'With environment variable',
    argExample: 'With process argument',
    clientTitle: 'Client Configuration',
    clientDescription: 'Configuration for clients that support stdio MCP servers.',
    clientConfig: 'MCP client JSON',
    toolsTitle: 'Tools',
    toolsDescription: 'Each tool call checks the Banana Shop API key and required scope first.',
    tool: 'Tool',
    scope: 'Scope',
    input: 'Input',
    examplesTitle: 'Tool Input Examples',
    examplesDescription:
      'Image tools return structured JSON. Data URL images are also attached as MCP image content.',
    imageExample: 'banana_generate_image',
    editExample: 'banana_edit_image',
    securityTitle: 'Authentication and Security',
    securityDescription:
      'The MCP server reuses the REST API key mechanism. Server-side secrets are never exposed to the browser.',
    security: {
      apiKey: {
        title: 'API Key Source',
        description: 'Read from BANANA_SHOP_API_KEY, BANANA_API_KEY, or the --api-key argument.',
      },
      scopes: {
        title: 'Scope Checks',
      ...
      history: {
        title: 'History',
        description:
          'Generation tools write Tale UserTask history by default. Pass recordHistory=false to skip it.',
      },
      secrets: {
        title: 'Secret Boundary',
        description:
          'TALE_APP_SECRET, BANANA_API_KEY_PEPPER, and provider keys are used only in the server process.',
      },
    },
  },
  error: {
